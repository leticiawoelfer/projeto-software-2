...
public class ExercicioFactory
{
    ...
    {
        d.addObjectCreate((new StringBuilder(String.valueOf(pattern))).append("/random").toString(), FurbotRandom.class);
        d.addObjectCreate((new StringBuilder(String.valueOf(pattern))).append("/randomX").toString(), FurbotRandom.class);
        d.addObjectCreate((new StringBuilder(String.valueOf(pattern))).append("/randomY").toString(), FurbotRandom.class);
