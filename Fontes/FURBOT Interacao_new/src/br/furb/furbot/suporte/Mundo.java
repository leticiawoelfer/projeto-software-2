...
public class Mundo {
	...
	private void doAndar(ObjetoMundoImpl objMundo, Direcao direcao, int novoX, int novoY) throws MundoException {
		int xAnt;
		int yAnt;
		MundoException me;
		xAnt = objMundo.getX();
	...
	public synchronized void andar(ObjetoMundoImpl objMundo, Direcao direcao) throws MundoException {
	...
	private boolean movimentar(ObjetoMundoImpl objMundo, int x, int y) throws MundoException {
	...
	public synchronized int getUltimaTeclaPress() throws MundoException {
